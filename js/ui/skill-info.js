...
let anchor=null;
function hide(){tip.classList.add('hidden');anchor?.removeAttribute('aria-describedby');anchor=null;}
function show(tag,p,id){
 hide();anchor=tag;tag.setAttribute('aria-describedby','skillTooltip');tip.replaceChildren();
